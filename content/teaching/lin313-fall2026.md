...
**Note:** Some material will draw on computational or statistical expertise to understand fully and may be difficult. We don’t expect you to have that expertise. So **don’t be daunted:** part of the point of this course is to talk through and get more familiar with these ideas and techniques.
...
- Dickinson, M., Glass, L., Brew, C., & Meurers, D. (2024). Language and computers. BoD–Books on Demand. Free PDF at: https://langsci-press.org/catalog/book/454 (click on PDF on the right panel). Specific PDFs will be posted online.
...
|2|Sep-01 (Tu)|Structure of Language 1|HW 1 released.|Read Rowland (2013). Ch 1<br>Pages 2 to 13 (before sec. 1.4)|
|2|Sep-03 (Th)|Structure of Language 2|||
|3|Sep-08 (Tu)|Encoding Language + Probability (if time permits)||DGBM Ch. 1 (Canvas)|
...
|6|Oct-01 (Th)|Intro to classification - Naive Bayes (not on mid term)|HW 2 Due.|[StatQuest's Naive Bayes](https://www.youtube.com/watch?v=O2L2Uv9pdDA) (youtube)<br>DGBM Ch. 5 (canvas)|
...
|8|Oct-15 (Th)|Classification/ML - Other algos (perceptron)|HW 3 released|DGBM Ch. 5 (canvas)|
|9|Oct-20 (Tu)|Evaluating Classification||DGBM Ch. 5 (canvas)|
...
An even more creative example is: "I want to understand X. Can you build a webapp that can explain by demonstration" (**Hint:** Many of the demos I made for this class would not have been possible without Claude.)
